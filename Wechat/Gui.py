...
def Connection():
    ...
    choice_label = tk.Label(connect_windo, text = 'Chioce: ', font=('calibre',10, 'bold'))
...
# Send_Button = tk.Button(text='Send Button',command=sending_msg)
